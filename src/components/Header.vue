                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            <p class="text-center mt-2  font-black" v-if="carrito.length === 0">El carrito esta vacio</p>
                            <div v-else>
                                ...
                                <table class="w-100 table" >
                                    ...
                                    <tbody >
                                        <tr  v-for="producto in carrito">
                                            ...
                                            <td>
                                                <button class="btn btn-danger" type="button" @click="$emit('remove-products',producto.id)">
                                                    X
                                                </button>
                                            </td>
                                        </tr>
                                ...
                                <p class="text-end">Total pagar: <span class="fw-bold">${{ totalAmout }}</span></p>
